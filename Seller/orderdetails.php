<?php
    require_once 'C:\MAMP\htdocs\PHP_codes\Project\conn.php';
    session_start();
?>
...
<body>
    ...
    <center>
        <?php
            try{ 
                $stmt=$conn->query("SELECT * FROM e_dukan.payment P,e_dukan.buyer B WHERE P.pid='".$_SESSION['pid']."' AND P.buyerid=B.buyerid");
                echo "";
